...
TODO
1. If no time_periods given then use full data for baseline.
2. Add parameter that exlcudes certain time_periods.
3. Dump metadata of optimal model. Also, save dataframe pulled from database.
4. Save matplotlib graphs.
5. Automate high_bound of data.
6. Add option to standardize/normalize data before fitting to model.
7. Add TimeSeriesSplit, ANN, SVM.
8. Add percent error, NMBE in Model_Data.py/display_metrics().
